    ...
    <div class="card shadow-sm border-0">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <i class="fas fa-edit me-2 text-primary"></i>Edit Kategori: {{ $category->name }}
            </h5>
        </div>
        <div class="card-body">
            <form action="{{ route('categories.update', $category) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div>
                        <span id="previewBadge" class="badge px-3 py-2" style="background-color: {{ $category->color ?? '#0d6efd' }}; color: white;">
